export const CONSTS = {
	...
	/**
	 * the maximum amount of video frames to keep for timeline filmstrips
	 */
	timelineFilmstripMaxFrames: 24,

	/**
	 * the generated width of each video filmstrip frame in pixels
	 */
	timelineFilmstripFrameWidth: 96,

	/**
	 * the generated height of each video filmstrip frame in pixels
	 */
	timelineFilmstripFrameHeight: 54,
