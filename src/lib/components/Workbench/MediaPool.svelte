<script lang="ts">
	...
	import { availableMedia, selectedElement } from '../../../stores/store';
	import MediaPoolElement from './MediaPoolElement.svelte';
	import MediaUpload from './MediaUpload.svelte';
	import TimelineElementSettings from './TimelineElementSettings.svelte';
...
{#if $selectedElement.elementId}
	<TimelineElementSettings></TimelineElementSettings>
{:else}
	<div
